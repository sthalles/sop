...
def get_args():
    ...
    parser.add_argument('--learned_abs_pos_emb', action='store_true')
    parser.add_argument('--disable_learned_abs_pos_emb', action='store_false', dest='learned_abs_pos_emb')
    parser.set_defaults(learned_abs_pos_emb=True)
    ...
    parser.add_argument('--lr', type=float, default=8e-3, metavar='LR',
                        help='learning rate (default: 4e-3, 8e−4, 9e−4, 1e−3, 2e−3)')
...
def main(args, ds_init):
    ...
    model = create_model(
        ...
        use_learned_abs_pos_emb=args.learned_abs_pos_emb,
    ...
    args.save_ckpt_freq = int(args.save_ckpt_freq * args.epochs / 100)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if data_loader_val is not None:
            ...
            with open(os.path.join(os.path.dirname(args.finetune), 'finetune_imnet.txt'), 'a+') as f:
                f.writelines(f'Max accuracy: {max_accuracy:.2f}%\n')

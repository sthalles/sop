...
def get_args_parser():
    ...
    parser.add_argument('--data_path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--data_set', default='IMNET', choices=['CIFAR', 'CIFAR10', 'IMNET', 'INAT', 'INAT19', 'Cars', 'image_folder', 'Flwrs'],
...
def train_one_epoch(model: torch.nn.Module, criterion: DistillationLoss,
    ...
    print("Model training mode:", set_training_mode)
...
def main(args):
    ...
    output_dir = Path(os.path.join(os.path.dirname(args.pretrained_weights), args.data_set))
